package com.arturk.customer.config;
...
@Slf4j
@Configuration
public class KafkaOrderCreatedEventConsumerConfig {
...
//        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaGroupId);
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.arturk.customer.dto.OrderCreatedEvent");
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        return configProps;
    }

    @Bean("orderCreatedEventConsumerFactory")
    public ConsumerFactory<String, Object> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(kafkaProperties());
    }

    @Bean("orderCreatedEventKafkaListenerContainerFactory")
