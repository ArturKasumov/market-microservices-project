   package com.arturk.storage.config;
...
@Slf4j
@Configuration
public class KafkaOrderCreatedConsumerConfig {
    ...
    public Map<String, Object> kafkaProperties() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.arturk.storage.dto.OrderCreatedEvent");
    ...
    @Bean("orderCreatedKafkaListenerContainerFactory")
